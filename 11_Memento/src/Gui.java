...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label labelY = new Label("Press Ctrl-Y to redo the last rollback");
        labelY.setPadding(insets);

        // create a VBox that contains the HBox and the CheckBox
        VBox vBox = new VBox(hBox, checkBox, labelZ, labelY);
    ...
    public void updateHistoryGUI() {
        List<IMemento> undone = controller.getUndone();
